// ---------------------------------------------------------------------------------------------------------------------
// <copyright file="OrSpecification.cs" company="OscarNET-SOFTware">
// ···
...
/// <summary>
/// Specification that represents a conditional OR operation that evaluates the second operand
/// only if the first operand evaluates to <c>false</c>.
/// </summary>
