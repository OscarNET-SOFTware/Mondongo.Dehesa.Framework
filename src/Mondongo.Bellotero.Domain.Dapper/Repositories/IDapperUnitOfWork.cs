// ---------------------------------------------------------------------------------------------------------------------
// <copyright file="IDapperUnitOfWork.cs" company="OscarNET-SOFTware">
// ···
...
/// <summary>
/// Extends the Unit of Work contract to support registration of custom Dapper repositories per entity type.
/// </summary>
public interface IDapperUnitOfWork : IUnitOfWork
{
    ...
    void RegisterQueryRepository<TAggregateRoot, TRepository>(Func<DbConnection, DbTransaction?, TRepository> factory)
    ...
    void RegisterCommandRepository<TAggregateRoot, TRepository>(Func<DbConnection, DbTransaction?, TRepository> factory)
